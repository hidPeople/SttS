...
export const TUTORIAL_TIPS: TutorialTipDefinition[] = [
  {
    id: 'endFirstTurn', eventBattleId: 'tutorial', turn: 1, delayMs: 30000,
  ...
  {
    id: 'useSeduction', eventBattleId: 'tutorial', turn: 3,
  ...
  {
    id: 'pullout', eventBattleId: 'tutorial', enemyState: 'inserted',
  ...
  {
    id: 'enemyAftershocks', eventBattleId: 'tutorial', enemyState: 'peakAftershocks',
